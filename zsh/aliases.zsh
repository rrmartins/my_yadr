...
# my git
alias gbs='git branch --set-upstream-to=origin/"$(git-branch-current 2> /dev/null)" "$(git-branch-current 2> /dev/null)"'
alias gcsm='git commit -S -m '
alias gck='git checkout '
alias gupstream='git fetch upstream && git pull upstream '
